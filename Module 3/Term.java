...
public class Term implements Comparable<Term> {
    ...
    * throws an IllegalArgumentException if length is less than or 
    * equal to zero. 
    */
   ...
   /**
    * Compares this term with the other term in ascending Lexicographic
    * order of query. 
    */
   @Override
   ...
   /**
    * Returns string representation of this term in the following format:
   ...
   /**
    * Comparator for Descending Weight.
    */ 
