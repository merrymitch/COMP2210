...
public final class Selector {
   ...
   public static int ceiling(int[] a, int key) {
      ...
      /** Counts the amount of values that are greater or equal
      to the key.**/
      int counter = 0;
      for (int i = 0; i < a.length; i++) {
         if (a[i] >= key) {
      ...
      /** If there are no values that are greater or equal 
      to the key, exception is thrown. **/
      if (counter == 0) {
         throw new IllegalArgumentException();
      }
      /** Puts the values that are greater or equal to key in 
      an array. **/
      int[] copyA = new int[counter];
      int counter2 = 0;
      for (int i = 0; i < a.length; i++) {
         if (a[i] >= key) {
            copyA[counter2] = a[i];
      ...
      /** Finds the minimum of the new array. **/
      int minimum = copyA[0];
   ...
   public static int floor(int[] a, int key) {
      ...
      /** Counts the amount of values that are less than or equal
      to the key.**/
      int counter = 0;
      for (int i = 0; i < a.length; i++) {
         if (a[i] <= key) {
      ...
      /** If there are no values that are less than or equal 
      to the key, exception is thrown. **/
      if (counter == 0) {
         throw new IllegalArgumentException();
      }
      /** Puts the values that are less than or equal to key in 
      an array. **/
      int[] copyA = new int[counter];
      int counter2 = 0;
      for (int i = 0; i < a.length; i++) {
      ...
      /** Finds the maximum of the new array. **/
      int maximum = copyA[0];
      for (int i = 1; i < copyA.length; i++) {
         if (copyA[i] > maximum) {
            maximum = copyA[i];
